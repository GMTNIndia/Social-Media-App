...
//     try {
//       await axios.post(`http://127.0.0.1:8000/api/users/${targetUserId}/unblock/`, null, {
//         headers: {
//           Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
//         },
//       });
//       // After successful unblocking, refetch the blocklist
//       fetchBlockedList();
//     } catch (error) {
...
//         <div className="flex justify-between space-x-4 mt-4">
//           <p className="text-sm text-red-600 cursor-pointer" onClick={openFollowersModal}>{followers} Followers</p> {/* Display followers count */}
//           <p className="text-smtext-blue-600 cursor-pointer" onClick={openFollowingModal}>{following} Following</p>
//           {/* <p className="text-sm text-blue-600 cursor-pointer" >Blocklist</p> Display following count */}
//           <p className="text-sm text-black cursor-pointer" onClick={openBlocklistModal}>Blocklist</p>
//           <p className="text-sm text-green-600">{posts} Posts</p>
//           {/* <p className="text-sm text-green-600">{posts} Posts</p> Display posts count */}
...
//                 <ul>
//                   {blockedList.map((user) => (
//                     <li key={user.id} className="py-2 border-b border-gray-200 flex justify-between items-center">
//                       <span>{user.username}</span>
//                       <button
//                         className="bg-green-500 text-white active:bg-green-600 font-bold uppercase text-xs px-2 py-1 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
//                         type="button"
