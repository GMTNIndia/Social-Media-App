...
//           `http://127.0.0.1:8000/chat/${currentChat.id}/`,
//           {
//             headers: {
//               Authorization: `Bearer ${token}`,
//             },
//           }
//         );
//         setMessages(chatIdResponse.data)

//         const chatId = chatIdResponse.data;
//         console.log("hello manish",chatIdResponse.data);
//         // Fetch the chat messages using chatId
//         const messagesResponse = await axios.get(
//           `http://127.0.0.1:8000/chat/${userId}/${chatId}/`,
//           {
//             headers: {
//               Authorization: `Bearer ${token}`,
//             },
//           }
//         );
//         // setMessages(messagesResponse.data.sort((a, b) => new Date(a.timestamp) - new Date(b.timestamp)));
//       } catch (error) {
//         console.error("Error fetching messages:", error);
//       }
//     };
...
//     ws.current = new WebSocket(`ws://127.0.0.1:8000/ws/chat/${currentChat.id}/`);
