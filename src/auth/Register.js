...
//   return (
//     <div className="min-h-screen mt-28 flex items-center justify-center bg-gray-100 pt-8 mb-8 pb-12">
...
function Register() {
  ...
  const handleChange = (e) => {
    ...
    if (id === 'mobile_number') {
      ...
      if (!isValidNumber) return; // Do not update state if value is not numeric
    }
  ...
  const validateMobileNumber = (number) => {
    const regex = /^[0-9]{10}$/; // Adjust this regex according to your requirements
