...
// //     >
// //       <nav className="flex gap-5 justify-between items-center w-full max-w-[1134px] flex-wrap">
// //         <img src={logo} alt="logo" style={{ width: '50px', height: '50px' }} className="max-md:w-12 max-md:h-12" />
// //         {isLoggedIn && (
// //           <div className="flex flex-wrap gap-5 text-stone-500 max-md:gap-2 max-md:w-full max-md:justify-between">
// //             <Link to="/" className={`flex flex-col justify-center items-center p-1 max-md:px-2 ${getLinkClass('/')}`}>
// //               <img
// //                 loading="lazy"
// //                 src="https://cdn.builder.io/api/v1/image/assets/TEMP/b1664f17de31a74869a435d8245a5bff6a6099341af5e4e18cffe780333ba51a?apiKey=87da4b67ae5046fdba58e532f6a97e48&"
// //                 alt="Home icon"
...
// //               />
// //               <span className="mt-1 text-xs max-md:text-sm">Home</span>
// //             </Link>
// //             <Link to="/search" className={`flex flex-col justify-center items-center p-1 max-md:px-2 ${getLinkClass('/search')}`}>
// //               <img
// //                 loading="lazy"
// //                 src="https://cdn.builder.io/api/v1/image/assets/TEMP/a511dbc6da42bdbbb0fd272e92643b13473f380bc6d4fccbdc2a1af2d8ed07d6?apiKey=87da4b67ae5046fdba58e532f6a97e48&"
// //                 alt="Search icon"
// //                 className="w-5 max-md:w-3"
// //               />
// //               <span className="mt-1 text-xs max-md:text-sm">Search</span>
// //             </Link>
// //             <Link to="/chat" className={`flex flex-col justify-center items-center p-1 max-md:px-2 ${getLinkClass('/chat')}`}>
// //               <img
// //                 loading="lazy"
// //                 src="https://cdn.builder.io/api/v1/image/assets/TEMP/111adcdfdb9cf521fbcfcfbd22a8b2e04fef72c425db95c4ff1062b74d214613?apiKey=87da4b67ae5046fdba58e532f6a97e48&"
// //                 alt="Chat icon"
// //                 className="w-6 max-md:w-4"
// //               />
// //               <span className="mt-1 text-xs max-md:text-sm">Chat</span>
// //             </Link>
// //             <Link to="/notification" className={`relative flex flex-col justify-center items-center p-1 max-md:px-2 ${getLinkClass('/notification')}`}>
// //               <img
// //                 loading="lazy"
// //                 src="https://cdn.builder.io/api/v1/image/assets/TEMP/22a444f9d586bdbcb11b510e804529feea918b4648917453af5408c10e4b6f46?apiKey=87da4b67ae5046fdba58e532f6a97e48&"
// //                 alt="Notification icon"
// //                 className="w-5 max-md:w-3"
// //               />
// //               <span className="mt-1 text-xs max-md:text-sm">Notification</span>
// //               {notificationCount > 0 && (
...
// //           {isLoggedIn ? (
// //             <button
// //               className="justify-center p-2 my-auto text-white rounded-md bg-zinc-600 hover:bg-zinc-700"
// //               onClick={handleLogout}
// //             >
// //               Logout
// //             </button>
// //           ) : (
// //             <>
// //               <Link to="/login" className={`text-white bg-slate-600 hover:bg-slate-700 mx-2 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs px-2 py-1 max-md:text-sm max-md:px-3 max-md:py-2 ${getLinkClass('/login')}`}>
// //                 Login
// //               </Link>
// //               <Link to="/register" className={`text-white bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs px-2 py-1 max-md:text-sm max-md:px-3 max-md:py-2 ${getLinkClass('/register')}`}>
// //                 Signup
// //               </Link>
// //             </>
// //           )}
...
//         <div className="hidden md:flex gap-5 text-stone-500 max-md:gap-2 flex-wrap">
//           {isLoggedIn && (
//             <>
//               <Link to="/" className={`flex flex-col justify-center items-center p-1.5 max-md:px-3 ${getLinkClass('/')}`}>
//                 <img
...
//         <div className={`fixed top-0 left-0 w-full h-full bg-white z-40 transform ${menuOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 md:hidden`}>
...
//             {isLoggedIn && (
//               <>
//                 <Link to="/" className={`p-2 ${getLinkClass('/')}`} onClick={closeMenu}>Home</Link>
//                 <Link to="/search" className={`p-2 ${getLinkClass('/search')}`} onClick={closeMenu}>Search</Link>
//                 <Link to="/chat" className={`p-2 ${getLinkClass('/chat')}`} onClick={closeMenu}>Chat</Link>
//                 <Link to="/notification" className={`p-2 ${getLinkClass('/notification')}`} onClick={closeMenu}>
//                   Notification
//                   {notificationCount > 0 && (
